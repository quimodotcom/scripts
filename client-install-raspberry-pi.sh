...
VERSION=2.11
DOWNLOAD_LINK=https://github.com/stream-pi/client/releases/download/1.0.0-EA%2B4-SNAPSHOT/stream-pi-client-linux-arm32-1.0.0-EA+4-SNAPSHOT-executable.zip
